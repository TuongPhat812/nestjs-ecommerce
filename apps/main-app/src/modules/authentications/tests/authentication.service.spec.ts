...
import mockedJwtService from '../../../utils/mocks/jwt.mock.service';
import mockedConfigService from '../../../utils/mocks/config.mock.service';
  ...
  describe('when accessing the data of authenticating user', () => {
    ...
    describe('and the provided password is not valid', () => {
      ...
      it('should throw an error', async () => {
        await expect(authenticationService.getAuthenticatedUser('user@email.com', 'strongPassword')).rejects.toThrow();
      });
    });
